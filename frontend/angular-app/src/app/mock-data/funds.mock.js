...
exports.MOCK_PERFORMANCE_DATA = exports.MOCK_FUND_TYPE_DISTRIBUTION = exports.MOCK_MARKET_INDICES = exports.generateMockTrendInfo = exports.generateMockKLineData = exports.MOCK_FUNDS = void 0;
// 模拟基金数据
exports.MOCK_FUNDS = [
    {
        id: 'fund_0001',
...
function generateMockKLineData(days) {
    ...
    for (var i = days; i >= 0; i--) {
        ...
        // 模拟OHLC数据
        var dailyChange = (Math.random() - 0.5) * 0.04; // ±2%波动
...
exports.generateMockKLineData = generateMockKLineData;
// 生成模拟涨跌信息
function generateMockTrendInfo(fund) {
    var changeAmount = fund.currentNav - fund.yesterdayNav;
    var changePercent = (changeAmount / fund.yesterdayNav) * 100;
    return {
...
exports.generateMockTrendInfo = generateMockTrendInfo;
// 模拟市场指数数据
exports.MOCK_MARKET_INDICES = [
...
// 模拟基金类型分布
exports.MOCK_FUND_TYPE_DISTRIBUTION = [
